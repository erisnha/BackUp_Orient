...
public class Bapi_IncomingInvoice_Park {
    ...
    public String pushInvoiceForPark(String processInstanceID) throws SQLException {
        System.out.println("inside pushInvoiceForPark Bapi_IncomingInvoice_Park");
        ...
        try {
            ...
            System.out.println("Query is 59:::::" + Query);
            ...
            if ("".equalsIgnoreCase(inv_park)
                  ...
                  System.out.println("processInstanceID is 84:" + processInstanceID);
                if (comp_code == null) {
